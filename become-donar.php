...
if (isset($_POST['submit'])) {
    ...
    $status = 1;
    $sql = "INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Message,status,latitude,longitude) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:message,:status,:latitude,:longitude)";
...
<body onload="getLocation();">
    ...
    <div class="container">
        ...
        <h1 class="my-5">Become a <small>Donor</small></h1>
        ...
        <?php } ?>
        <!-- Content Row -->
        <form name="donar" class="donor my-5 py-5" method="post">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-4 mb-4">
                    ...
                    <div><input class="form-control" type="text" name="latitude"></div>
                </div>

                <div class="col-lg-8 mb-4">
                    <div class="font-italic">longitude</div>
                    <div><input class="form-control" type="text" name="longitude"></div>
                </div>
            </div>
    ...
    function showPosition(position) {
        document.querySelector('.donor input[name ="latitude"]').value = position.coords.latitude;
        document.querySelector('.donor input[name ="longitude"]').value = position.coords.longitude;
    }
    </script>
